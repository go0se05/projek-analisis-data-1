...
weather_totals = day_df.groupby("weather_condition")["total_rentals"].sum().astype(int)
sns.lineplot(x=weather_totals.index.astype(int), y=weather_totals.values, marker='o')
...
st.write("- Puncak peminjaman terjadi pada jam 07:00–09:00 dan 17:00–18:00 pada hari kerja.")
